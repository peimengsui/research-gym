"""Learner scaffold for the DDIM sampling lesson.

Earlier diffusion utilities and the tiny U-Net are included as working code.
Your TODOs focus on the deterministic DDIM sampler.
"""
...
def make_ddim_timesteps(num_ddpm_timesteps: int, num_ddim_steps: int) -> torch.Tensor:
    ...
    # TODO: return evenly spaced integer timesteps including 0 and T - 1.
...
def predict_x0_from_noise(
    ...
    # TODO: implement the clean-sample estimate from x_t and predicted noise.
    raise NotImplementedError
...
def ddim_reverse_step(
    ...
    # - estimate x0
    # - gather alpha_bar_t and alpha_bar_s
    # - compute sigma, direction, and x_previous
...
def ddim_sample_loop(
    ...
    # TODO:
    # - choose DDIM timesteps
    # - start from initial_noise or Gaussian noise
    # - walk backward through timestep pairs
    # - optionally collect the trajectory
    raise NotImplementedError
