"""Learner scaffold for a tiny variable-duration audio language model."""
...
def make_audio_prefix_attention_mask(
    ...
    # TODO 1: Add valid separator/text positions, build dense-prefix/causal-text
    # structure, then require both query and key positions to be valid.
...
class AudioTextSequenceEmbedding(nn.Module):
    ...
    def forward(
        ...
        # TODO 2: Encode audio, append separator/text embeddings, add unified
        # positions, build the attention mask, and return AudioTextSequence.
        raise NotImplementedError
...
class TinyAudioLanguageModel(nn.Module):
    ...
    def forward(
        ...
        # TODO 3: Build the sequence, run provided blocks, normalize, slice text
        # positions, project vocabulary logits, and compute optional CE loss.
        raise NotImplementedError
