"""Learner scaffold for the Transformer Block lesson."""
...
class FeedForward(nn.Module):
    ...
    def __init__(self, embed_dim: int, expansion_factor: int = 4):
        super().__init__()
        # TODO: Build embed_dim -> expanded hidden dim -> embed_dim.
        # Use GELU between the two linear layers.
        self.network: nn.Sequential

    def forward(self, x: torch.Tensor) -> torch.Tensor:
        """Apply the same MLP independently at each sequence position."""

        # x: [batch, time, embed_dim]
        raise NotImplementedError("TODO: run the feed-forward network")
...
class TransformerBlock(nn.Module):
    ...
    def __init__(self, embed_dim: int, expansion_factor: int = 4):
        ...
        # TODO: Add LayerNorm before attention and before the MLP.
        self.norm1: nn.LayerNorm
        self.norm2: nn.LayerNorm
        # TODO: Add the feed-forward MLP sublayer.
    ...
    def forward(
        ...
        """Apply attention and MLP residual sublayers.
        ...
        raise NotImplementedError("TODO: implement pre-norm residual block")
